...
<div class="jumbotron text-center">
  <h1>Pick a tree to delete!</h1> 
  <p>We hate to see them go but it has to happen sometimes.</p>
  <form class="form-inline" action="/tree-obliterate.php" align = "center">
    <div class="input-group">
      <input type="text" name="keyword" class="form-control" size="50" placeholder="Insert a Tree ID" required>
